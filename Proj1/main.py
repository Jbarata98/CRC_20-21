...
def main():
    ...
    #variables array format  = num_nodes,num_edges,deg_hist,prob_deg_hist,n_node_degs,degreeCount,cum_degree,degrees
    ...
    plot_degree_maker(n_nodes_degrees,n_nodes_degs_prefattach,analysis_array[6],analysis_array_random[6], POWER_LAW=True,RANDOM_NET = True)
    ...
    plot_degree_maker(n_nodes_degrees,n_nodes_degs_prefattach,analysis_array[6],analysis_array_prefattach[6], POWER_LAW=False,PREF_ATTACH = True)

    #linreg
    print("\nLinear Regression:\n")
    #print(list(set(analysis_array[7])))
    #linear_regression(list(set(analysis_array[7])),analysis_array[3])
